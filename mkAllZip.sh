...
awk '/0.0.1/{flag=1}/^$/{flag=0}flag' ../ReleaseNotes.txt > latestReleaseNotes.txt
gh release create --title v"$version" v"$version" --draft --notes-file latestReleaseNotes.txt --prerelease KrankyBearImg2IconsWinAMD.zip KrankyBearImg2IconsMacOSAMD.zip KrankyBearImg2IconsMacOSARM.zip KrankyBearImg2IconsSetup.exe KrankyBearImg2IconsARM.dmg KrankyBearImg2IconsIntel.dmg
